...
from logistiki.dec import dec, gr2dec, is_afm
from logistiki.grdate import date_gr2iso
        ...
        for lin in ofil:
            ...
            if llin > 86:
                ...
                if cod.startswith('53.'):
                    # if afm:
                    by_code[cod] = {'eponymia': epo,
                                    'afm': afm, 'syn_code': cod}
